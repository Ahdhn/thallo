...
local terra NewState(params : Thallo_InitializationParameters) : &LibraryState
    ...
    -- Set global variables from Thallo_InitializationParameters
    C.lua_pushboolean(L,params.doublePrecision);
    C.lua_setfield(L,LUA_GLOBALSINDEX,"_thallo_double_precision")

    var verbosityLevel : C.lua_Number = params.verbosityLevel
    C.lua_pushnumber(L,verbosityLevel);
    C.lua_setfield(L,LUA_GLOBALSINDEX,"_thallo_verbosity")

    var timingLevel : C.lua_Number = params.timingLevel
    C.lua_pushnumber(L,timingLevel);
    C.lua_setfield(L,LUA_GLOBALSINDEX,"_thallo_timing_level")
    ...
    C.lua_setfield(L,LUA_GLOBALSINDEX,"_thallo_threads_per_block")

    C.lua_pushnumber(L,params.useAutoscheduler)
    C.lua_setfield(L,LUA_GLOBALSINDEX,"_thallo_use_autoscheduler")

    C.lua_pushnumber(L,params.cpuOnly)
    C.lua_setfield(L,LUA_GLOBALSINDEX,"_thallo_use_cpu_only")
